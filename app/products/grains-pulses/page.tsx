...
const products = [
  ...
  },
  {
    id: "2",
    name: "Organic Quinoa",
    description: "Protein-rich ancient grain, perfect for salads and sides",
    price: 7.99,
    image: "/placeholder.svg?height=200&width=200",
    category: "grains",
    rating: 4.9,
  },
  {
    ...
    description: "Quick-cooking lentils, ideal for soups and stews",
    price: 4.49,
    image: "/placeholder.svg?height=200&width=200",
    category: "pulses",
    rating: 4.7,
  },
  {
    ...
    description: "Versatile legumes for hummus, curries, and salads",
    price: 3.99,
    image: "/placeholder.svg?height=200&width=200",
    category: "pulses",
    rating: 4.6,
  },
  {
    ...
    description: "Hearty breakfast oats for porridge and baking",
    price: 4.29,
    image: "/placeholder.svg?height=200&width=200",
    category: "grains",
    rating: 4.8,
  },
  {
    id: "6",
    name: "Organic Millet",
    description: "Gluten-free ancient grain with a mild, nutty flavor",
    price: 5.49,
    image: "/placeholder.svg?height=200&width=200",
    category: "grains",
    rating: 4.5,
...
export default function GrainsPulsesPage() {
  return (
    <div className="container py-8">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-bold">Organic Grains & Pulses</h1>
      </div>
          ...
          <div className="sticky top-24 border rounded-lg p-4 space-y-6">
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <input type="checkbox" id="rice" className="mr-2" defaultChecked />
                  <label htmlFor="rice">Rice</label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="grains" className="mr-2" defaultChecked />
                  <label htmlFor="grains">Grains</label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="pulses" className="mr-2" defaultChecked />
                  <label htmlFor="pulses">Pulses & Lentils</label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="flour" className="mr-2" />
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  <input type="checkbox" id="high-protein" className="mr-2" />
                  <label htmlFor="high-protein">High Protein</label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="whole-grain" className="mr-2" />
                  <label htmlFor="whole-grain">Whole Grain</label>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                  <Link href={`/products/grains-pulses/${product.id}`}>
